...
class SendPhoneRssiFragment : Fragment(), LocationListener {
    private var _binding: FragmentSendPhoneRssiBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSendPhoneRssiBinding.inflate(inflater, container, false)
        return binding.root
    ...
    private fun generateFormBody(): FormBody {
        ...
        val isImmobile = "0"
        val message = "RSSI of Phone to Device: " + binding.editTextRSSI.text
